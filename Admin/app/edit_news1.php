...
<button type="submit" id='save' class="btn btn-primary pd-x-30 pd-y-15 tx-uppercase tx-bold tx-spacing-6 tx-12 mg-t-30 wd-200" onclick="update('<?php echo $news->_id; ?>');">SUBMIT</button>
...
// alert('hi');
        ...
        alert(formData);
        $.ajax({
             url:'http://localhost:3051/news/update'+id,
           type : 'PATCH',
            data : formData,
            async : false,
            cache : false,
