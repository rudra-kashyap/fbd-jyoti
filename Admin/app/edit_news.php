...
$curl = curl_init();
  curl_setopt($curl, CURLOPT_URL, "http://localhost:3051/news/".$id);
...
<form action="" method="POST" id='myform'>
    ...
    <select class="form-control select2 mg-b-20" data-placeholder="Choose Category" id="category" name="news_category" value="<?php echo $alldata->news_category; ?>">
...
<input class="form-control" id="heading" name="blog_heading" placeholder="Input box" type="text" value="<?php echo $alldata->blog_heading; ?>">
<h6 class="tx-gray-800  tx-bold tx-18 mg-t-30 mg-b-10 ">Author</h6>
<input class="form-control" id="author" name="author" placeholder="Input box" type="text" value="<?php echo $alldata->author; ?>">
<h6 class="tx-gray-800  tx-bold tx-18 mg-t-30 mg-b-10 ">Cover Image</h6>
<label class="custom-file">
  <input type="file" id="blog_image" name="blog_image" class="custom-file-input" value="<?php echo $alldata->blog_image; ?>">
  <span class="custom-file-control"></span>
</label>
<h6 class="tx-gray-800  tx-bold tx-18 mg-t-30 mg-b-10 ">News Content</h6>
          <div id="summernote" class="pd-80 "></div>
<input type="hidden" value="<?php echo $alldata->_id; ?>" name="_id" id="id">
...
// alert(dataid);
   ...
   // alert(formData);
        $.ajax({
             url:'http://localhost:3051/news/update'+dataid,
           type : 'PATCH',
            data : formData,
            async : false,
            cache : false,
